	\section{Feature extraction}
		\label{sec:feature}
			...
			The amount of seconds in at the locations are summed up, the average noise, luminosity and temperature are calculated. From the sleep stages the total amount of sleep could be calculated, the amount of wake in bed and also the sleep efficiency (the relative time slept in bed)
