\section{Sensor Systems}
	...
	\subsection{BioHarness}
			...
			\begin{itemize}
				...
				\item Athletes who would like to track their progress.
			...
			The accelerometer measures the physical acceleration of the user in the x-, y- and z-axis and its unit is in $g$. One $g$ is 9.88 metres per second squared.  The sampling rate is 100 Hz. The range is from $-16g$ to $16g$ for each axis. The acceleration magnitude is $\sqrt{(\Delta X)^2+(\Delta Y)^2+(\Delta Z)^2}$.
			...
			The electrocardiography (ECG) \cite{ECG} sensor measures the electrical activity of the heart. See Figure~\ref{fig:ecg} for a graph of the results that an ECG produces. The sampling frequency is 1000 Hz.
